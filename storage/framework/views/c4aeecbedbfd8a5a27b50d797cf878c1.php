<?php $__env->startSection('title', 'Penjualan - K5 Mart'); ?>
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-slate-900">
                    <?php echo e(number_format($totalTransaksi, 0, ',', '.')); ?>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-slate-900">
                    <?php echo e(number_format($hariIni, 0, ',', '.')); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-5 py-4 text-slate-600 whitespace-nowrap">
                            ...
                            <?php echo e($penjualan->created_at
        ...
        <div class="px-5 py-4 border-t border-slate-200">
            ...
            <div class="flex flex-col sm:flex-row
                ...
                <div class="flex items-center gap-1">
                    ...
                    <?php $__currentLoopData = $penjualans->getUrlRange(
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\k5_mart\resources\views/penjualan/index.blade.php ENDPATH**/ ?>